...
![Screenshot-gost](https://raw.githubusercontent.com/Shjpr9/Gost-ip6/955933ccb4111291b2cc343a3f55e1fe05c83864/image/Screenshot_20240430_113105.jpg).
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/Shjpr9/Gost-ip6/main/install.sh)
   ```

Custom Version: 

```bash
bash <(curl -Ls https://github.com/Shjpr9/Gost-ip6/raw/v2.1.7/Gost.sh)
   ```
